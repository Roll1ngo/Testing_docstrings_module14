...
from examples_tests.src.get_recipe.get_recipe import get_recipe
...
class TestClass(unittest.TestCase):
    ...
    def test_first_line(self):
        ...
        with patch('builtins.open', self.mock_open_file):
            ...
            self.assertEqual( result.get('id'), uuid)
            self.assertEqual( result.get('name'), 'Herbed Baked Salmon')
    ...
    def test_second_line(self):
        ...
        with patch('builtins.open', self.mock_open_file):
            result = get_recipe(filename, uuid)
            self.assertEqual(result.get('id'), uuid)
            self.assertEqual(result.get('name'), 'Lemon Pancakes')
